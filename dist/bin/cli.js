...
program
    ...
    try {
        ...
        if (options.health) {
            ...
            const health = new DocumentationHealth(path.resolve(process.cwd(), userConfig.docsRoot), path.resolve(process.cwd(), userConfig.sourceRoot), path.resolve(process.cwd(), userConfig.cacheDir || './.doc-architect-cache'), userConfig.mappings);
        ...
        const architect = new DocArchitect({
            ...
            budgetStrategy: options.budgetStrategy || 'balanced',
